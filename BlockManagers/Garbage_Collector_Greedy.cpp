...
void Garbage_Collector_Greedy::register_event_completion(Event & event) {
	...
	Address const& ra_test = event.get_replace_address();
	printf("LRU EVENT %d -%d =%d\n", a.get_linear_address(), ra_test.get_linear_address(), a.get_linear_address()-ra_test.get_linear_address());
	//sim edit end
