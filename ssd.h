...
public:
	...
	inline uint get_last_pages_invalid() const { return last_pages_invalid; }
	inline void set_last_pages_invalid(uint new_last_pages_invalid)  { last_pages_invalid= new_last_pages_invalid; }
